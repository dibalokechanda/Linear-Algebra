...
$$
\mathbf{A}\mathbf{x} = \left[ \begin{array}{c}\langle \mathbf{a^{\prime^\top}_1},\mathbf{x }\rangle  \\\ \langle \mathbf{a^{\prime^\top}_2},\mathbf{x }\rangle \\ \vdots \\ \langle \mathbf{a^{\prime^\top}_n},\mathbf{x}\rangle\end{array} \right]
$$
