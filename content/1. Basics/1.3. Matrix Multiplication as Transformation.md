...
> - It is a "stretching" transformation because $d_{11}=d_{22}>1$ .  The exact value of $d_{ii}$ will determine the "amount of stretch". 
...
The geometric interpretation of this transformation is an uniform shrinking along both axis. 
## References
